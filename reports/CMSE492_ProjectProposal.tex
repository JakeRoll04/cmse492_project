...
\bottomrule
\end{tabular}
\caption{Training and inference times for each model. (Values depend on hardware.)}
...
train, the gain in predictive quality justifies the additional cost.
...
could include hyperparameter tuning for all models, exploring XGBoost for faster
